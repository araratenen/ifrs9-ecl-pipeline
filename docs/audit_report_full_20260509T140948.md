...
| Audit timestamp | `2026-05-09T14:09:48` |
...
|---|:---:|---|---|---|---|
| 1.1 | ✓ PASS | All expected files exist | all 50 files present | all present |  |
...
| ID | Status | Description | Observed | Expected | Notes |
|---|:---:|---|---|---|---|
| 13.1 | ✓ PASS | test_predictions has columns Step 9c needs | ['default_flag', 'id', 'issue_d', 'lgd_predicted', 'pd_lr', 'pd_lr_calibrated', 'pd_xgb', 'pd_xgb_calibrated'] | ['default_flag', 'id', 'issue_d', 'pd_lr', 'pd_xgb'] |  |
