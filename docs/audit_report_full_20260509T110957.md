...
| Audit timestamp | `2026-05-09T11:09:57` |
...
| 1.3 | ⚠ WARN | No orphan/unexpected files | orphans=['models/pd_logistic_calibrator.pkl', 'models/pd_xgboost_calibrator.pkl', 'docs/calibration_post.json', 'docs/reliability_pre_xgb.csv', 'docs/reliability_pre_lr.csv', 'docs/calibration_comparison.json', 'docs/reliability_post_lr.csv', 'docs/calibration_pre.json', 'docs/reliability_combined.c | none |  |
...
| ID | Status | Description | Observed | Expected | Notes |
|---|:---:|---|---|---|---|
| 13.1 | ✓ PASS | test_predictions has columns Step 9c needs | ['default_flag', 'id', 'issue_d', 'pd_lr', 'pd_lr_calibrated', 'pd_xgb', 'pd_xgb_calibrated'] | ['default_flag', 'id', 'issue_d', 'pd_lr', 'pd_xgb'] |  |
