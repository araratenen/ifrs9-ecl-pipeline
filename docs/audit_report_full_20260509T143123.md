...
| Audit timestamp | `2026-05-09T14:31:23` |
...
|---|:---:|---|---|---|---|
| 1.1 | ✓ PASS | All expected files exist | all 64 files present | all present |  |
...
| ID | Status | Description | Observed | Expected | Notes |
|---|:---:|---|---|---|---|
| 13.1 | ✓ PASS | test_predictions has columns Step 9c needs | ['default_flag', 'ead_12m', 'ead_lifetime_discounted_total', 'ecl_12m', 'ecl_lifetime', 'ecl_total', 'id', 'ifrs9_stage', 'issue_d', 'lgd_predicted', 'months_remaining', 'pd_12m', 'pd_lifetime', 'pd_lr', 'pd_lr_calibrated', 'pd_xgb', 'pd_xgb_calibrated'] | ['default_flag', 'id', 'issue_d', 'pd_lr', 'pd_xgb'] |  |
