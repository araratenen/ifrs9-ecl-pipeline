...
| Audit timestamp | `2026-05-09T15:19:02` |
...
|---|:---:|---|---|---|---|
| 1.1 | ✓ PASS | All expected files exist | all 89 files present | all present |  |
| 1.2 | ✓ PASS | All files loadable in expected format | all loadable | all loadable |  |
| 1.3 | ⚠ WARN | No orphan/unexpected files | orphans=['data/dashboard'] | none |  |
