...
| Audit timestamp | `2026-05-09T18:21:53` |
...
| ID | Status | Description | Observed | Expected | Notes |
|---|:---:|---|---|---|---|
| 21.0 | ✗ FAIL | Category execution error | KeyError: 'n_loans' | no exception |  |

## ⚠️ Action Required

Fix the following before proceeding to Step 9c:

- **21.0 Category execution error** — see category table above for observed vs expected.
...
If all 1 FAIL items are resolved, the pipeline is ready for Step 9c.
